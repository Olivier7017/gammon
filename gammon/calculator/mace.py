...
class MaceCalc(LammpsCalc):
    def __init__(self,
        ...
        """
        pair_style = "pair_style mace no_domain_decomposition\n"
    ...
    def get_interaction_energy_ASE(self, atoms, proc_id):
        """
    ...
    def __str__(self):
        ...
        s += "Energy calculated using Lammps\n"
        return s
